...
var Group = (0, _GroupContainer2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  this.renderChildren = function () {
    ...
    return props.children1 ? props.children1.map(function (item, key) {
      return _react2.default.createElement(
        'div',
        { className: 'rule-wrapper', key: key },
        _react2.default.createElement(
          'span',
          null,
  ...
  this.handleVisibleChange = function (popoverVisible) {
    _this2.setState({ popoverVisible: popoverVisible });
  };
}, _temp)) || _class;
